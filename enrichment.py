# perform an go enrichment analysis of the hub proteins that was found in the network analysis

from fetch_data import fetch_go_enrich

# take the raw dataframe and check 1. it is there and 2. not empty before it filters the data based on the false discovery rate threshold. If no significant terms are found it will return none
