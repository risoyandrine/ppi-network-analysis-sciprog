...
# the network graph is build from the interaction data we fetched from the STRING database
...
# define the hub-proteins, which are the proteins with the highest degree centrality, so we use the degree centrality to identify these 
...
# create a dictionary with the values obtained from the calculations
...
# print a summary of the network properties to summarize the network properties
